...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="view-account">
        <h2>Account Details <asp:Button ID="Label2" runat="server" Text="Joint Account" CssClass="Tab" OnClick="Label2_Click"></asp:Button><asp:Button ID="Label3" runat="server" Text="Single Account" CssClass="Tab" OnClick="Label3_Click"></asp:Button></h2>
