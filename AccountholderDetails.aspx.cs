...
public partial class AccountholderDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            String ac = Request.QueryString["a"].ToString();
    ...
    {
        String msg = lc.UpdateSingleAccount(Convert.ToInt32(Label1.Text),TextBox5.Text, TextBox7.Text, TextBox8.Text, TextBox9.Text, TextBox10.Text, TextBox11.Text, TextBox20.Text, TextBox21.Text, TextBox22.Text, TextBox23.Text, TextBox24.Text, TextBox25.Text);
